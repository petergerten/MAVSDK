...
public:
    ...
    struct PositionGlobalYaw {
        ...
        float lat{}; /**< @brief Position North (in metres) */
        float lon{}; /**< @brief Position East (in metres) */
        float alt{}; /**< @brief Position Down (in metres) */
        float yaw_deg{}; /**< @brief Yaw in degrees (0 North, positive is clock-wise looking from above) */
    };
    ...
    /**
     * @brief Equal operator to compare two `Offboard::VelocityGlobalYaw` objects.
     *
     * @return `true` if items are equal.
     */
    friend bool operator==(const Offboard::VelocityGlobalYaw& lhs, const Offboard::VelocityGlobalYaw& rhs);

    /**
     * @brief Stream operator to print information about a `Offboard::VelocityGlobalYaw`.
     *
     * @return A reference to the stream.
     */
    friend std::ostream& operator<<(std::ostream& str, Offboard::VelocityGlobalYaw const& velocity_global_yaw);
     ...
     * @return Result of request.
     */
    Result set_velocity_global(VelocityGlobalYaw velocity_global_yaw) const;
